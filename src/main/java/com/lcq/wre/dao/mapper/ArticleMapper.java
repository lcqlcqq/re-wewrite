package com.lcq.wre.dao.mapper;
...
@Repository
public interface ArticleMapper extends BaseMapper<com.lcq.wre.dao.pojo.Article> {
    /**
     * 查询时间归档
     * @return
     */
    ...
    List<com.lcq.wre.dao.pojo.Article> listFavorites(@Param("userId") Long userId);
    //连接代替子查询：
